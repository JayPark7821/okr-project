...
public class User extends BaseTimeEntity implements UserDetails {
    ...
    @Builder
    public User(Long userSeq, String userId, String username, String password, String email, String emailVerifiedYn, String profileImageUrl, ProviderType providerType, RoleType roleType, JobFieldDetail jobField) {
